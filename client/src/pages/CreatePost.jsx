    ...
    if (form.prompt) {
      try {
        setGeneratingImg(true);
          const response = await fetch('https://ai-image-generator-rx25.onrender.com/api/v1/dalle', {
            method: 'POST',
            headers: {
              "Content-Type": "application/json",
            },
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Create imaginative and visually stunning images through Image-AI</p>
      </div>
